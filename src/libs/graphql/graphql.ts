...
export const GetPixelsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetPixels' },
      variableDefinitions: [
        {
        ...
        },
        {
          ...
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'pixelaw_PixelWhereInput' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'pixelawPixelModels' },
            arguments: [
              {
                kind: 'Argument',
...
} as unknown as DocumentNode<GetPixelsQuery, GetPixelsQueryVariables>
