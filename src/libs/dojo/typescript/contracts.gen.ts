  ...
  function paint_actions() {
    ...
    const put_color = async (props: { account: Account; default_params: models.DefaultParameters }) => {
      try {
        ...
        console.error("Error executing put_color:", error);
        throw error;
      }
    };
    ...
    const fade = async (props: { account: Account; default_params: models.DefaultParameters }) => {
      try {
        ...
        console.error("Error executing fade:", error);
        throw error;
      }
    };

    // Call the `pixel_row` system with the specified Account and calldata
    const pixel_row = async (props: {
      account: Account;
      ...
      try {
        return await provider.execute(
          props.account,
          {
            ...
            calldata: [props.default_params, ...props.image_data],
          },
          "pixelaw"
        );
      } catch (error) {
        console.error("Error executing pixel_row:", error);
        throw error;
      }
    };
      ...
      try {
        return await provider.execute(
          props.account,
          {
            contractName: contract_name,
            entrypoint: "interact",
            calldata: [props.default_params, ["None", "Left", "Right", "Up", "Down"].indexOf(props.direction.type)],
          },
          "pixelaw"
        );
      } catch (error) {
