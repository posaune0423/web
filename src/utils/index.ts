...
export const felt252ToString = (felt252: string | number | bigint): string => {
  if (typeof felt252 === 'bigint' || typeof felt252 === 'object') {
    return shortString.decodeShortString(`0x${felt252.toString(16)}`)
  }
  if (felt252 === '0x0' || felt252 === '0') return ''

  const strValue = felt252.toString()
  try {
