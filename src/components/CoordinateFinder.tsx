      ...
      <div className="flex items-center space-x-2">
        <label htmlFor="x" className="flex items-center text-white lg:font-semibold text-xs lg:text-base h-full">
          ...
          <input
            ...
            className="rounded-md focus:outline-none focus:border-slate-900 p-1 ml-1 bg-transparent w-fit max-w-[4ch] appearance-none border border-white [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
